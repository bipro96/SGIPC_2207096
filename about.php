            ...
            <div class="container">
                <div class="grid-2">
                    ...
                    <div class="animate-on-scroll">
                        ...
                        <p class="text-secondary mt-2" style="font-size: 1rem; line-height: 1.8;">
                            By 2027, we aim to triple our active membership and establish a permanent programming lab dedicated to competitive programming research and practice.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="section section-tinted">
            <div class="container">
                ...
                <div class="animate-on-scroll" style="max-width: 800px; margin: 0 auto;">
                    <p class="text-secondary" style="font-size: 1.0625rem; line-height: 1.8; text-align: center; margin-bottom: var(--space-xl);">
                        Competitive programming is a mind sport where participants write programs to solve well-defined problems under time and memory constraints. It combines mathematics, algorithm design, data structures, and efficient coding into a high-pressure, rewarding challenge.
                    </p>
                </div>
                <div class="grid-3">
                    <div class="card animate-on-scroll">
                        <div class="about-feature-icon">01</div>
                        <h3 class="card-title">Problem Solving</h3>
                        <p class="card-text">Analyze complex problems, break them down, and devise optimal solutions using mathematical reasoning and algorithmic thinking.</p>
                    </div>
                    <div class="card animate-on-scroll">
                    ...
                    <div class="card animate-on-scroll">
                        ...
                        <h3 class="card-title">Global Competitions</h3>
                        <p class="card-text">Compete on platforms like Codeforces, AtCoder, and in prestigious contests like ICPC, Meta Hacker Cup, and Google Code Jam.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="grid-4">
                    <div class="card animate-on-scroll text-center">
                        ...
                        <p class="card-text">SGIPC was established by a small group of passionate programmers at KUET.</p>
                    </div>
                    <div class="card animate-on-scroll text-center">
                        <div class="card-date">2018</div>
                        <h3 class="card-title">First ICPC Team</h3>
                        <p class="card-text">Our first team qualified for the ICPC Asia Dhaka Regional contest.</p>
                    </div>
                    <div class="card animate-on-scroll text-center">
                        <div class="card-date">2022</div>
                        <h3 class="card-title">100 Members</h3>
                        <p class="card-text">Reached 100 active members and launched our first official training curriculum.</p>
                    </div>
                    <div class="card animate-on-scroll text-center">
